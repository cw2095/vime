...
let g:listbox_fzf_content = [
                ...
                \ ["FZF Jump&s\t<M-J>", 'FzfJumps'],
                \ ["FZF Search H&istory\t<M-/>", 'History/'],
                \ ["FZF Ma&ps\t<M-M>", 'Maps'],
                \ [ "--", ''  ],
                \ ["FZF &Quickfix", 'FzfQuickfix'],
                \ ["FZF Locatio&nList", 'FzfLocationList'],
                \ [ "--", ''  ],
...
call quickui#menu#install("&File", [
            ...
            \ [ "Q&uit\t:q(\\q)", 'quit', 'quit without save'],
            \ [ "Save &All\t:wall", 'wall', 'save all open files'],
...
call quickui#menu#install('&Tools', [
            ...
            \ [ "GotoFile\tgf", 'call Toos_GotoFile("new")' ],
            ...
            \ ['Traili&ng Space', 'call StripTrailingWhitespace()', ''],
            \ ['--',''],
            \ [ "&Dictionary", "call Open_Dictionary_Cword()", "query current word(use sdcv)" ],
            \ [ "Open Manual", "call feedkeys(':OpenManual  ')" ],
            \ [ "Lo&g text", "call feedkeys(':Log  ')", "log some text into ~/.cache/vim/logs/record.log " ],
            ...
            \ [ "La&zygit", "call quickui#tools#terminal('lazygit')" ],
            \ ['--',''],
            ...
            \ ['Pr&ofile Stop', 'call MonitorExit()', ''],
            \ ])
...
call quickui#menu#install('&Plugin', [
            ...
            \ ["&Choose Window/Tab\t<M-->", "ChooseWin", "fast switch win/tab with vim-choosewin"],
            \ [ "Open &Browse\tgx", "call openbrowser#_keymap_smart_search('n')", 'Browse word in www'],
            \ [ "Open &GitHubFile\tgh", "OpenGithubFile", 'Opens current files URL in github.com' ],
